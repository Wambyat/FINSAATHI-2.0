          ...
          <>
            ...
            <Box className="question-area">
              <FormControl component="fieldset">
                <FormLabel component="legend" sx={{ fontSize: '2.2rem' }}>{questions[currentQuestion].question}</FormLabel>
                <RadioGroup
                  aria-label="question"
                  name="question"
                ...
                >
                  {questions[currentQuestion].answers.map((answer, index) => (
                    <FormControlLabel
                      ...
                      label={<Typography sx={{ fontSize: '2.1rem', color: answer === selectedAnswer ? 'red' : 'gray' }}>{answer}</Typography>}
                    />
                  ))}
                </RadioGroup>
              </FormControl>
